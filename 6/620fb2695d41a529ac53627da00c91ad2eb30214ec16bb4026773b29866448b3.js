...
if(!(BrowserDetection.browser==="Explorer")){try{j.inspectJSFunctions();
c=false
}catch(a){b=b||true
...
}if(!(BrowserDetection.browser==="Explorer")){j.handleSizeLimit()
}};
...
}function add_deviceprint(){BrowserDetection.init();
var d;
switch(BrowserDetection.browser){case"Explorer":d=new IE_FingerPrint();
break;
...
c=c+"&pm_os="+BrowserDetection.OS+"&pm_brmjv="+parseInt(BrowserDetection.version,10)+"&pm_br="+BrowserDetection.browser;
...
}var BrowserDetection={init:function(){}