(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["qidianMonitor"] = factory();
	else
		root["qidianMonitor"] = factory();
...
(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__("adaf"), __webpack_require__("7302"), __webpack_require__("9f8f"), __webpack_require__("13f4")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_exports, _aegisWebSdk, _baseLog, _cookie, _uin) {
  "use strict";
  ...
  _aegisWebSdk = _interopRequireDefault(_aegisWebSdk);
  _baseLog = _interopRequireDefault(_baseLog);
  _cookie = _interopRequireDefault(_cookie);
  _uin = _interopRequireDefault(_uin);
  ...
  var defaultConig = {
    // 上报主号维度
    ext3: _cookie.default.get('corp_uin') // api: {
    //     // 上报请求参数详情
    //     apiDetail: true,
    // },
  ...
  var QdAegis = /*#__PURE__*/function (_BaseLog) {
    _inherits(QdAegis, _BaseLog);

    var _super = _createSuper(QdAegis);

    function QdAegis(params, config) {
      var _this;

      _classCallCheck(this, QdAegis);

      _this = _super.call(this, 'rum', params); // const findConfig = require(`config/${super.projectName}.json`)['rum'][super.env]        
      // const findConfig = config[this.projectName][this.env];

      _this.config = _objectSpread(_objectSpread(_objectSpread({}, defaultConig), config), {
        uin: (0, _uin.default)(),
      ...
      _this.params = params;
      _this.instance = new _aegisWebSdk.default(_objectSpread(_objectSpread({}, _this.config), {}, {
        beforeReport: function beforeReport(log) {
          var customerLog = true;
          var func = me.computeFunc('beforeReport');
          if (func) customerLog = func(log);
          return customerLog;
        },
        onReport: me.computeFunc('afterReport'),
        beforeReportSpeed: function beforeReportSpeed(log) {
          var customerLog = log;
          var func = me.computeFunc('beforeReportSpeed');
          if (func) customerLog = func(log);
          return customerLog;
        },
        onBeforeRequest: function onBeforeRequest(log) {
          var customerLog = log;
          var func = me.computeFunc('beforeRequest');
          if (func) customerLog = func(log);
          return customerLog;
        }
      }));
      return _this;
    } // { level: '1', name: '接口请求日志（白名单日志）' } 默认值
    // { level: '2', name: '一般日志' }
    ...
    _createClass(QdAegis, [{
      key: "log",
      value: function log() {
        // console.log("do instance log", this.instance, args)
        if (this.params && this.params.rumIgnoreWhiteList) {
          var _this$instance;

          (_this$instance = this.instance).infoAll.apply(_this$instance, arguments);
        } else {
          var _this$instance2;

          (_this$instance2 = this.instance).info.apply(_this$instance2, arguments);
        }
      }
    }, {
      key: "error",
      value: function error() {
        ...
        (_this$instance3 = this.instance).error.apply(_this$instance3, arguments);
      }
    }, {
      key: "customerReport",
      value: function customerReport() {
        var _this$instance4;

        (_this$instance4 = this.instance).reportEvent.apply(_this$instance4, arguments);
      }
    }, {
      key: "reportTime",
      value: function reportTime() {
        ...
        (_this$instance5 = this.instance).reportTime.apply(_this$instance5, arguments);
      }
    }, {
      key: "timeStart",
      value: function timeStart() {
        ...
        (_this$instance6 = this.instance).time.apply(_this$instance6, arguments);
      }
    }, {
      key: "timeEnd",
      value: function timeEnd() {
        ...
        (_this$instance7 = this.instance).timeEnd.apply(_this$instance7, arguments);
      }
    }, {
      key: "destory",
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  /*
   * @Author: your name
   * @Date: 2021-08-17 15:19:03
   * @LastEditTime: 2022-02-16 19:06:34
   * @LastEditors: Please set LastEditors
   * @Description: In User Settings Edit
   * @FilePath: /qidian-monitor/src/page/monitor/js/utils/env.js
   */
  var ENV = {
    oa: 'oa',
    gray: 'gray',
  ...
  _exports.ENV = ENV;
  var envMap = {
    'admin.qidian.qq.com': ENV.online,
    'console.qidian.qq.com': ENV.online,
    'webpage.qidian.qq.com': ENV.online,
    'qidian.qq.com': ENV.online,
    'm.qidian.qq.com': ENV.online,
    'b.boss.com': ENV.online,
    'boss2.b.qq.com': ENV.online,
    'boss.qidian.woa.com': ENV.online,
    'oaadmin.qidian.qq.com': ENV.oa,
    'oawebpage.qidian.qq.com': ENV.oa,
    'oaconsole.qidian.qq.com': ENV.oa,
    'oa.qidian.qq.com': ENV.oa,
    'oa.m.qidian.qq.com': ENV.oa,
    'oa.b.boss.com': ENV.oa,
    'oaboss2.b.qq.com': ENV.oa,
    'oa.boss.qidian.woa.com': ENV.oa,
    'dev.boss.qidian.woa.com': ENV.dev,
    'dev.b.boss.com': ENV.dev,
    'localhost': ENV.dev,
    'local.qidian.qq.com': ENV.dev,
    'chat.oa.qdkefu.com': ENV.oa,
    'chat.ol.qdkefu.com': ENV.online,
    'static.oa.qdkefu.com': ENV.oa,
    'webpage.oa.qdkefu.com': ENV.oa,
    'webpage.ol.qdkefu.com': ENV.online,
    'oa.114.qq.com': ENV.oa,
    '114.qq.com': ENV.online,
    'oa.huodai.qidian.qq.com': ENV.oa,
    'huodai.qidian.qq.com': ENV.online,
    'webpage.ol.qdwpa.com': ENV.online,
    'webpage.oa.qdwpa.com': ENV.oa,
    "oa.store.qidian.qq.com": ENV.oa,
    "store.qidian.qq.com": ENV.online
  }; // 获取当前属于哪个环境，

  function getEnv() {
    var env = envMap[window.location.hostname];

    if (env === undefined) {
      console.error("host '".concat(window.location.hostname, "' is not in qidian-monitor defined, please add host config in qidian-monitor first"));
      return ENV.dev;
    }
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__("9f8f")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(typeof globalThis !== "undefined" ? globalThis : typeof self !== "undefined" ? self : this, function (_exports, _cookie) {
  "use strict";
  ...
  var getUin = function getUin() {
    // 工号左侧去除: O 大写O，o 小写o，空格，0 数字0  
    var re = /^[0|O|o|\s]+/;

    var uin = _cookie.default.get('aid') || _cookie.default.get('p_uin');
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{\"id\":\"\"},\"oa\":{\"id\":\"yaoVL8AlJ1ZeMDq4dG\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"RZ9L5lAEPvjdBXWxmE\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{\"id\":\"xxxxxxxx\"},\"oa\":{\"id\":\"kXD2YxMe7JJ7AzeWb1\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"a37qVxBO5GGbNOd9EW\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{},\"oa\":{\"id\":\"WoakZYMDv169AepK2R\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"olD0gVNnGY3DMdWKv1\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{\"id\":\"xxxxxxxx\"},\"oa\":{\"id\":\"yaoVL8AlJ1EPMDq4dG\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"7EY0d5B2eY6nMzkqVm\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{},\"oa\":{\"id\":\"wRb2YVAW7GapA7xWZP\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"VL6vPlAbR2O4A3wdoW\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{\"id\":\"xxxxxxxx\"},\"oa\":{\"id\":\"Z4vVGEA6o9mxNaY3Op\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"7EY0d5B2eYLLMzkqVm\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
var map = {
	"./b2b-qq.json": "5ea6",
	"./boss-pro.json": "e3c6",
	"./contact-clone.json": "baac",
	"./cs-static.json": "1ff7",
	"./friend-clone.json": "f270",
	"./online-visitor.json": "beb2",
	"./qdweb-build.json": "3843",
	"./qidian-cloud.json": "23ea",
	"./qidian-cs-static.json": "908e",
	"./qidian-ea.json": "1da8",
	"./qidian-imvideo.json": "3db4",
	"./qidian-infocard.json": "642c",
	"./qidian-qq-friend.json": "9c6c",
	"./qidian-qss.json": "5ad8",
	"./qidian-spa.json": "c6ca",
	"./qidian-vea.json": "190b",
	"./qidian-webim.json": "8926",
	"./qidian-workbench-h5.json": "b5f3",
	"./qidian-workbench.json": "ef5f",
	"./qidian-workorder.json": "ecd8",
	"./relationshipChainSelector.json": "594c",
	"./rhino-components.json": "53f3",
	"./rhino-lite.json": "4e43",
	"./wait-pool.json": "ab49"
};
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{\"id\":\"xxxxxxxx\"},\"oa\":{\"id\":\"16VgDflKG6PYEzZ54J\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"XV3klcgQRW1zQKm68O\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{\"id\":\"\"},\"oa\":{\"id\":\"3mpyYVMLl7wrM9Wax5\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"e18J4KBxEazdAEZrLY\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{\"id\":\"xxxxxxxx\"},\"oa\":{\"id\":\"Yeo6VnNQVG31MldG3z\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"p3JgoKBVDG3oNWYe78\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{\"id\":\"xxxxxxxx\"},\"oa\":{\"id\":\"r5aW2clVxZgbJg8Glb\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"qVmndtLxRla9nYZYjG\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{},\"oa\":{\"id\":\"RmZ4GdB3oR4VBQenX8\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"n043EbNKJGjbAJxKgz\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{\"id\":\"xxxxxxxx\"},\"oa\":{\"id\":\"RZ9L5lAEPvvmBXWxmE\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"yaoVL8AlJ111MDq4dG\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  /*
   * @Author: leoqyli
   * @Date: 2021-08-17 11:58:30
   * @LastEditTime: 2021-09-16 17:51:33
   * @LastEditors: Please set LastEditors
   * @Description: 定义上报日志的基类
   * @FilePath: /qidian-monitor/src/page/monitor/js/plugins/base.js
   */
  // import { getEnv } from '../utils/env';
  var BaseLog = /*#__PURE__*/function () {
    function BaseLog(name, params) {
      ...
      if (!params.projectName) {
        throw new Error('projectName is must be defined!');
      }

      BaseLog.prototype.projectName = params.projectName; // this.env = getEnv();
    ...
    _createClass(BaseLog, [{
      ...
      value: function log() {
        ...
        if (this.showConsole) (_console = console).log.apply(_console, arguments);
      ...
      key: "send",
      value: function send() {
        console.log('send 未定义');
      } // 错误信息上报

    }, {
      key: "error",
      value: function error() {} // 自定义上报

    }, {
      key: "customerReport",
      value: function customerReport() {} // 自定义测速上报
      ...
      key: "timeEnd",
      value: function timeEnd() {} // 通过 hostanme，项目名称，及用于自定义配置，自动合并生成最终配置

    }, {
      key: "getConig",
      value: function getConig() {
        this.config;
      } // 计算定制方法，如： rumBeforeReport

    }, {
      key: "computeFunc",
      value: function computeFunc(name) {
        var nameArr = _toConsumableArray(name);

        var upperCaseName = this._name + nameArr[0].toLocaleUpperCase() + nameArr.splice(1, nameArr.length - 1).join('');
        if (this.params[upperCaseName]) return this.params[upperCaseName];
    ...
    return BaseLog;
  }(); // BaseLog.prototype.env = getEnv();


  var _default = BaseLog;
  _exports.default = _default;
});
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{\"id\":\"xxxxxxxx\"},\"oa\":{\"id\":\"QlWyV8Np049bN15Yok\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"hostUrl\":\"//tamaegis.com\",\"spa\":true},\"online\":{\"id\":\"5JeqGKMr5aEJNlbkXa\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"hostUrl\":\"//tamaegis.com\",\"spa\":true}}}");
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{\"id\":\"xxxxxxxx\"},\"oa\":{\"id\":\"39v4Q2B8lE0yBeJZwp\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"PR8Q4VBmZvg6A3gmKO\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{},\"oa\":{\"id\":\"nGLywFKDbK7dvmy378\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"okLymuba6b535k0er5\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var _default = {
     ...
     */
    set: function set(name, value, domain, path, expires) {
      if (expires) {
        expires = new Date(+new Date() + expires);
      }

      var tempcookie = "".concat(name, "=").concat(escape(value)).concat(expires ? "; expires=".concat(expires.toGMTString()) : '').concat(path ? "; path=".concat(path) : '').concat(domain ? "; domain=".concat(domain) : ''); // Ensure the cookie's size is under the limitation
     ...
     */
    get: function get(name) {
      var carr = doc.cookie.match(new RegExp("(^| )".concat(name, "=([^;]*)(;|$)")));
    ...
    del: function del(name, domain, path) {
      if (this.get(name)) {
        doc.cookie = "".concat(name, "=").concat(path ? "; path=".concat(path) : '').concat(domain ? "; domain=".concat(domain) : '', ";expires=Thu, 01-Jan-1970 00:00:01 GMT");
      }
...
module.exports = JSON.parse("{\"rum\":{\"dev\":{\"id\":\"xxxxxxxx\"},\"oa\":{\"id\":\"PVqyZlB0G192MGvOwE\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true},\"online\":{\"id\":\"p3JgoKBVDGmDNWYe78\",\"reportApiSpeed\":true,\"reportAssetSpeed\":true,\"spa\":true}}}");
