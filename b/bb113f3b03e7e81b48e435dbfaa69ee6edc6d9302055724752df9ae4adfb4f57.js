...
function Cb(a){return new ub(vb,a)}
var wb={},vb={};Cb("");var Db=String.prototype.trim?function(a){return a.trim()}:function(a){return/^[\s\xa0]*([\s\S]*?)[\s\xa0]*$/.exec(a)[1]},Eb=/&/g,Fb=/</g,Gb=/>/g,Hb=/"/g,Ib=/'/g,Jb=/\x00/g,Kb=/[\x00&<>"']/;function Lb(a,b){this.i=b===Mb?a:""}
...
;var fc={};function kc(a){this.i=fc===fc?a:"";this.oa=!0}
kc.prototype.ja=function(){return this.i.toString()};
kc.prototype.toString=function(){return this.i.toString()};var lc=/^[\w+/_-]+[=]{0,2}$/;function mc(){var a=A.document;return a.querySelector?(a=a.querySelector('style[nonce],link[rel="stylesheet"][nonce]'))&&(a=a.nonce||a.getAttribute("nonce"))&&lc.test(a)?a:"":""}
...
if(qd){var Vd={};Object.defineProperties(L,(Vd[Symbol.hasInstance]=rd(Object[Symbol.hasInstance]),Vd))};var Wd=window;Cb("csi.gstatic.com");Cb("googleads.g.doubleclick.net");Cb("partner.googleadservices.com");Cb("pubads.g.doubleclick.net");Cb("securepubads.g.doubleclick.net");Cb("tpc.googlesyndication.com");/*
