...
(function(h){function(){}function i(d,c){2<=j||(document.createElement("img").src=k(d,0,h.conf.appKey,c),j++)
...
(function(c){var g=function(){}(),e=function(){function(){}d.prototype.submit=function(f){this.push(f)&&c.initEXTDone&&this.processQ()
};
d.prototype.processQ=function(){};
...
}}function(){}var e=function(){function d(f){this.perf=new c.PerformanceTracker;
...
(function(c){var e=function(){function(){}f.prototype.pg=function(d){this.na(f.Gb,d)
};
...
return null
}}function(){}j.startTimeCookie=null;
...
d.prototype.adjustTimings=function(){};
...
},onbeforeXhrReq:function(){},onafterXhrReq:function(){this.e.stopCorrelatingXhrs()
}}},e.prototype)
})(c.ng||(c.ng={}))
})(b||(b={}));
(function(c){(function(g){var e=function(){function(){}d.prototype.h=function(f,j){c.log("M59",f);
...
f.decorator("$httpBackend",["$delegate",function(j){return j=h.around(j,function(){},function(){i.j.h(g.c.Hb)
})
}])
};
...
j.$on("$locationChangeStart",function(){});
j.$on("$locationChangeSuccess",function(){i.j.h(g.c.gg)
});
j.$on("$routeChangeStart",function(){}